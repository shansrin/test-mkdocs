...
/**
 * Test the multiple-proxy-sample.
 *
...
public class MultipleProxiesSampleIT
     ...
     */
    public MultipleProxiesSampleIT(String sOperatorChartURL, String sCoherenceChartURL)
        {
    ...
    public void testMultipleProxiesSample() throws Exception
        ...
        if (testShouldRun())
            ...
            testProxyConnection(m_asReleases[0], 20000);
            testProxyConnection(m_asReleases[0], 20001);
            }
        }
    }
